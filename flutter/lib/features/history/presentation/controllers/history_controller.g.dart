...
String _$selectedHistoryPeriodHash() =>
    r'1d9df26e4c0c55c67cbcff73e876ac14c88cb9cb';
...
///
/// Copied from [SelectedHistoryPeriod].
@ProviderFor(SelectedHistoryPeriod)
final selectedHistoryPeriodProvider =
    AutoDisposeNotifierProvider<SelectedHistoryPeriod, HistoryPeriod>.internal(
      SelectedHistoryPeriod.new,
      name: r'selectedHistoryPeriodProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$selectedHistoryPeriodHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$SelectedHistoryPeriod = AutoDisposeNotifier<HistoryPeriod>;
