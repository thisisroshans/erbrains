...
import '../controllers/connection_activity_controller.dart';
...
class ConnectionScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final activity = ref.watch(connectionActivityProvider);
        ...
        child: ListView(
          ...
          children: [
            ...
            if (activity.isEmpty)
              ...
              for (final entry in activity) _ActivityRow(entry: entry),
